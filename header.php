...
<title><?php if($page_title != "DayByDayVA - Calendario de alfabetización familiar"){echo $page_title . " | DayByDayVA - Calendario de alfabetización familiar";}else{echo "Day by Day VA - Calendario de alfabetización familiar";}?></title>
...
<body class="<?php echo $body_class; ?>">
  <div id="top_wrap">
	...
	<div id="head_logos">
      <h1><a href="/"><img src="/img/logo.png" alt="Day by Day VA - Calendario de alfabetización familiar" class="logo"></a><span class="month_button"></span><?php echo $page_title; ?></h1>
	</div>